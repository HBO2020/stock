...
export class RattachementComponent implements OnInit {
  ...
  constructor(
    protected rattachementService: RattachementService,
  ...
  protected onSuccess(data: IRattachement[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/rattachement'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
